...
public class Solution {
    ...
    public static class Object {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            java.lang.String str1 = reader.readLine();
            java.lang.String str2 = reader.readLine();
            int storecountStrings = countStrings;
            if (str1.startsWith("string #")){
                countStrings = Integer.parseInt(str1.replace("string #", "")) - 1;
                string1 = new String();
                countStrings = storecountStrings;
            }

            if (str2.startsWith("string #")){
                countStrings = Integer.parseInt(str2.replace("string #", "")) - 1;
                string2 = new String();
                countStrings = storecountStrings;
            }
        }
